...
//use frontend\modules\account\widgets\Connect;
    ...
    <div class="col-md-4 col-md-offset-4">
        <div class="login-panel panel panel-default">
            ...
            <div class="panel-body">           
                ...
                <?= $form->field($model, 'password', ['inputOptions' => ['class' => 'form-control', 'tabindex' => '2']])->passwordInput()->label('密码' . ($module->enablePasswordRecovery ? ' (' . Html::a('忘记密码', ['/account/request'], ['tabindex' => '5']) . ')' : ''))?>
            ...
            <p class="text-center">
                <?= Html::a('没有收到确认消息?', ['/account/resend'])?>
            </p>
        <?php endif ?>
        <?php if ($module->enableRegistration): ?>
            <p class="text-center">
                <?= Html::a('没有一个帐户吗?去注册吧!', ['/account/register'])?>
            </p>
        <?php endif ?>
    </div>
</div>